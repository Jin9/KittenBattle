...
public class buyRing : MonoBehaviour {

	public Canvas cantBuy;
	public Canvas ringCan;
	...
	public void clickBuyFood(){
		...
		if (shopManager.instance.ispopup == false) {
			...
			if (firstManeger.instance.money < 200) {
				cantBuy.gameObject.SetActive(true);
				shopManager.instance.ispopup = true;
			}
			else{
				
				if(firstManeger.instance.ringC1 == "1" && firstManeger.instance.ringC2 == "1" && firstManeger.instance.ringC3 == "1"){
					//have all
					...
					ringCan.gameObject.SetActive(true);
					if(firstManeger.instance.ringC1 == "0"){
					...
					if(firstManeger.instance.ringC2 == "0"){
					...
					if(firstManeger.instance.ringC3 == "0"){

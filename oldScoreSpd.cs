...
public class oldScoreSpd : MonoBehaviour {

	public static oldScoreSpd instance;
	private string saveURL = "http://tu-seal.net/kitten/oldScoreSpd.php";
